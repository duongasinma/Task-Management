...
namespace DemoIndentityCore.Data
{
    public class DemoIndentityCoreContext : IdentityDbContext<DemoIndentityCoreUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<UserTask>().HasKey(l => new { l.TaskId, l.UserId });
        ...
        private void SeedUser(ModelBuilder builder)
        {
            ...
            PasswordHasher<DemoIndentityCoreUser> pHas = new PasswordHasher<DemoIndentityCoreUser>();          
            user.PasswordHash = pHas.HashPassword(user, "Admin*123");
